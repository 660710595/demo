    ...
    <div className="todo-container">
        ...
        {filteredTodos.length === 0 ? (
          ...
          <li className="empty-state">
            ...
            <p>
              ...
              {filter === 'active' && 'ยังไม่มีรายการ เพิ่มรายการแรกของคุณเลย'}
              {filter === 'completed' && 'ยังไม่มีรายการ เพิ่มรายการแรกของคุณเลย'}
            </p>
          </li>
        ) : (
      ...
      {completedCount > 0 && (
        <div className = 'todo-footer'>
          <button className = 'clear-btn' onClick = {clearCompleted}>เลือกรายการที่เสร็จแล้ว</button>
        </div>
      )}
    </div>
  )
